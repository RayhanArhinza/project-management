...
class RoleController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('member.roles.create', compact('allRoutes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('member.roles.index')->with('success', 'Role created successfully.');
    }
    ...
    {
        $allRoutes = $this->getAllRoutes();
        return view('member.roles.edit', compact('role', 'allRoutes'));
    }
    ...
    public function update(Request $request, Role $role)
    {
        ...
        return redirect()->route('member.roles.index')->with('success', 'Role updated successfully.');
    }
    ...
    {
        $role->delete();
        return redirect()->route('member.roles.index')->with('success', 'Role deleted successfully.');
    }
